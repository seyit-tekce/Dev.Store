...
namespace Dev.Store.AspNetCore.Mvc.UI.Theme.MultiKart.Themes.MultiKart.Components.Toolbar.LanguageSwitch;
...
public class LanguageSwitchViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View("~/Themes/Multikart/Components/Toolbar/LanguageSwitch/Default.cshtml", model);
    }
}
