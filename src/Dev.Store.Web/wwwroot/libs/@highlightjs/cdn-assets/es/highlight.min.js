...
;if(!N)throw z(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
...
className:"variable",match:`\\$${Te}+`}],M=[{match:/(@|#(un)?)available/,
...
;return{name:"Visual Multikart .NET",aliases:["vb"],case_insensitive:!0,
