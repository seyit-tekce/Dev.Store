...
namespace Dev.Store.AspNetCore.Mvc.UI.Theme.MultiKart.Themes.MultiKart.Components.Toolbar;
...
public class MainNavbarToolbarViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View("~/Themes/Multikart/Components/Toolbar/Default.cshtml", toolbar);
    }
}
