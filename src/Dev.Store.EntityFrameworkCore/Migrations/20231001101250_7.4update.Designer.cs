...
namespace Dev.Store.Migrations
{
    ...
    [Migration("20231001101250_7.4update")]
    partial class _74update
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dev.Store.Address.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dev.Store.HomeSliders.HomeSlider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppHomeSliders", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Store.OrderActions.OrderAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOrderActions", null, t =>
                        {
                            t.HasComment("");
                        });
                });

            modelBuilder.Entity("Dev.Store.OrderAddress.OrderAdress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOrderAddresses", null, t =>
                        {
                            t.HasComment("");
                        });
                });

            modelBuilder.Entity("Dev.Store.OrderProducts.OrderProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOrderProducts", null, t =>
                        {
                            t.HasComment("");
                        });
                });

            modelBuilder.Entity("Dev.Store.OrderSets.OrderSet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOrderSets", null, t =>
                        {
                            t.HasComment("");
                        });
                });

            modelBuilder.Entity("Dev.Store.OrderSizes.OrderSize", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOrderSizes", null, t =>
                        {
                            t.HasComment("");
                        });
                });
            ...
            modelBuilder.Entity("Dev.Store.ProductSets.ProductSet", b =>
                {
                    ...
                    b.ToTable("AppProductSets", (string)null);
                });

            modelBuilder.Entity("Dev.Store.ProductSizes.ProductSize", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppProductSizes", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Store.SeoSettings.SeoSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSeoSettings", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Store.Address.Address", b =>
                {
                    b.HasOne("Dev.Store.Locations.Location", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dev.Store.Locations.Location", "Town")
                        .WithMany()
            ...
            modelBuilder.Entity("Dev.Store.HomeSliders.HomeSlider", b =>
                {
                    b.HasOne("Dev.Store.UploadFiles.UploadFile", "UploadFile")
                        .WithOne()
                        .HasForeignKey("Dev.Store.HomeSliders.HomeSlider", "UploadFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dev.Store.OrderActions.OrderAction", b =>
                {
                    b.HasOne("Dev.Store.Orders.Order", "Order")
            ...
            modelBuilder.Entity("Dev.Store.OrderAddress.OrderAdress", b =>
                {
                    b.HasOne("Dev.Store.Address.Address", "Address")
                        .WithMany()
                    ...
                    b.HasOne("Dev.Store.Orders.Order", "Order")
                        ...
                        .HasForeignKey("Dev.Store.OrderAddress.OrderAdress", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dev.Store.OrderSets.OrderSet", b =>
                {
                    ...
                    b.HasOne("Dev.Store.OrderProducts.OrderProduct", "OrderProduct")
                        .WithMany("OrderSets")
                        .HasForeignKey("SetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dev.Store.SeoSettings.SeoSetting", b =>
                {
                    b.HasOne("Dev.Store.Products.Product", "Product")
                        .WithOne("SeoSetting")
                        .HasForeignKey("Dev.Store.SeoSettings.SeoSetting", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
