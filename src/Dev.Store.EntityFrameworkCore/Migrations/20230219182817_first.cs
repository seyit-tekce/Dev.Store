        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProductSets_AppProducts_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProductSizes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppProductSizes_AppProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "AppProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSeoSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppSeoSettings_AppProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "AppProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppProductSets_ProductId",
                table: "AppProductSets",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductSizes_Code",
                table: "AppProductSizes",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductSizes_ProductId",
                table: "AppProductSizes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSeoSettings_ProductId",
                table: "AppSeoSettings",
                column: "ProductId",
                unique: true);
