...
public class StoreBrandingProvider : IDevBrandingProvider, ITransientDependency
{
    ...
    public string PhoneNumber => SiteSettings.SiteSettingPhoneNumber;
    public string Email => SiteSettings.SiteSettingEmail;
    public string Address => SiteSettings.SiteSettingAddress;
}
